...
which establishes the desired relation and allows us to find all divisors of an integer by iterating to <img src="./svgs/d12a0737370c512d2be42efc7c4d279f.svg?invert_in_darkmode" align=middle width=23.565549149999992pt height=24.995338500000003pt/>. 
<!-- name: divisors -->
```python
import math
